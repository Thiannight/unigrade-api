package com.unigrade.api.endpoint.event.consumer;

import com.unigrade.api.PojaGenerated;
import com.unigrade.api.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.unigrade.api.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.unigrade.api.service.event."
