        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/auth/login", "/ping", "/health/**")
                    ...
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/groups/*/courses/*/exams/*/grades")
                    .hasAnyRole("ADMIN", "TEACHER")
                    .requestMatchers(HttpMethod.POST, "/groups/*/courses/*/exams")
                    .hasAnyRole("ADMIN", "TEACHER")
                    .requestMatchers(HttpMethod.PUT, "/groups/*/courses/*/exams/*")
                    .hasAnyRole("ADMIN", "TEACHER")
                    .requestMatchers(HttpMethod.DELETE, "/groups/*/courses/*/exams/*")
                    .hasAnyRole("ADMIN", "TEACHER")
